...
@Module({
  ...
  }), ChatModule, AuthModule, DeviceIntegrationModule, LabReportsModule, NotificationsModule, ProfileModule, TipsModule, VitalsModule, FitbitModule, NudgeModule, StravaModule],
  controllers: [],
